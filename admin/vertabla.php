                ...
                <TR> 
                  <TD><TABLE width="100" border="0" cellspacing="0" cellpadding="0">
                      <TR> 
                        ...
                        <TD><INPUT name="chequear[borrar]" type="button" class="BtnEliminarOff" value="" onMouseOver="this.className='BtnEliminarOver';" onMouseOut="this.className='BtnEliminarOff';" onClick="borrarSel()"></TD>
                        <TD><IMG src="image/spacer.gif" width="8" height="1"></TD>
                        <TD><IMG src="image/pipe.gif" width="2"></TD>
                        <TD><IMG src="image/spacer.gif" width="8" height="1"></TD>
                      </TR>
      ...
      <TD colspan="3" align="center" bgcolor="#F0F0F0"> 
        <TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <TR> 
            ...
            <TD width="15"><A href="?base=<? echo $base ?>&tabla=<? echo $tabla ?>">x</A></TD>
          </TR>
